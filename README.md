...
## This Jupyter notebook performs sentiment analysis on Amazon product reviews using spaCy and TextBlob. It analyses the sentiment of customer reviews and visualises the results using word clouds.
